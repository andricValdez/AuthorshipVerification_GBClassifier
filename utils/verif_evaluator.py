...
def main(truth_file, pred_file, output_dir):
    
    # load:
    gt = load_file(truth_file)
    ...
    with open(output_dir + os.sep + 'evaluation.json', 'w') as f:
        json.dump(results, f, indent=4, sort_keys=True)
    
    with open(output_dir + os.sep + 'evaluation.prototext', 'w') as f:
